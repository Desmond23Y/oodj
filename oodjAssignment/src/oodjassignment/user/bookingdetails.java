...
public class bookingdetails extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (Aschedule.getColumnModel().getColumnCount() > 0) {
            Aschedule.getColumnModel().getColumn(0).setMinWidth(70);
            Aschedule.getColumnModel().getColumn(0).setPreferredWidth(70);
            Aschedule.getColumnModel().getColumn(0).setMaxWidth(70);
            ...
            Aschedule.getColumnModel().getColumn(3).setMinWidth(55);
            Aschedule.getColumnModel().getColumn(3).setPreferredWidth(55);
            Aschedule.getColumnModel().getColumn(3).setMaxWidth(55);
            ...
            Aschedule.getColumnModel().getColumn(5).setMinWidth(85);
            Aschedule.getColumnModel().getColumn(5).setPreferredWidth(85);
            Aschedule.getColumnModel().getColumn(5).setMaxWidth(85);
            Aschedule.getColumnModel().getColumn(6).setMinWidth(85);
            Aschedule.getColumnModel().getColumn(6).setPreferredWidth(85);
            Aschedule.getColumnModel().getColumn(6).setMaxWidth(85);
